        ...
        <div className="container mx-auto px-4 py-8">
            ...
            {selectedOrders.length > 0 && (
                <div className="bg-white rounded-lg shadow-md p-4 mb-6 flex justify-between items-center">
                    <div>
                        <span className="font-medium">{selectedOrders.length} đơn hàng đã chọn</span>
                    </div>
                    <div className="flex space-x-2">
                        <select
                        ...
                        >
                            ...
                            <option value="pending">Đánh dấu chờ xử lý</option>
                            <option value="processing">Đánh dấu đang xử lý</option>
                            <option value="shipped">Đánh dấu đang giao hàng</option>
                            <option value="delivered">Đánh dấu đã giao hàng</option>
                                ...
                                {orders.map(order => (
                                    <tr key={order.id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            ...
                                            >
                                                Đánh dấu là {order.paymentStatus === 'paid' ? 'Chưa thanh toán' : 'Đã thanh toán'}
                                            </button>
                                        </td>
                                    </tr>
                                ))}
                    ...
                    <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                        <div>
                            <p className="text-sm text-gray-700">
                                Hiển thị trang <span className="font-medium">{currentPage}</span> trong tổng số <span className="font-medium">{totalPages}</span>
                            </p>
                        </div>
                        <div>
